        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex gap-4">
            <div className="bg-white/20 rounded-xl px-4 py-2 text-center backdrop-blur-sm">
              <p className="text-2xl font-bold">{currentTabMembers.length}</p>
              <p className="text-xs text-green-100">Cadastrados</p>
            </div>
            <div className="bg-white/20 rounded-xl px-4 py-2 text-center backdrop-blur-sm">
              <p className="text-2xl font-bold">
                {currentTabMembers.filter(m => getLatestReportForMember(m.id) !== null).length}
              </p>
              <p className="text-xs text-green-100">Relataram</p>
            </div>
            <div className="bg-white/20 rounded-xl px-4 py-2 text-center backdrop-blur-sm">
              <p className="text-2xl font-bold">
                {currentTabMembers.filter(m => getLatestReportForMember(m.id) === null).length}
      ...
      <div className="flex gap-2 mb-6 flex-wrap">
        {tabs.map(tab => (
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold transition-all shadow-sm ${activeTab === tab.id
        ...
        <div className="flex flex-col md:flex-row gap-3 items-start md:items-center justify-between">
          <div className="flex gap-3 flex-1 flex-wrap">
            ...
            <select
              ...
              className="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-gray-50 text-gray-700"
            >
          ...
          <button
            ...
            className="bg-green-600 text-white px-5 py-2 rounded-lg hover:bg-green-700 flex items-center gap-2 transition-all text-sm font-semibold shadow-sm hover:shadow-md"
          >
            <Plus size={16} />
                      ...
                      <tr key={member.id} className="hover:bg-green-50/30 transition-colors group">
                        ...
                        <td className="py-3.5 px-5 text-right">
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 text-gray-400 hover:text-red-600 transition-all p-1.5 rounded-lg hover:bg-red-50"
                            title="Excluir"
                          >
                            <Trash2 size={15} />
                          </button>
